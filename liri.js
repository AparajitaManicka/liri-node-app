...
function spotifythissong() {
    ...
    if (nodeArgs.length > 3) {
        ...
        clients
            .search({ type: "track,album", query: "The Sign,Ace of Base", limit: 1 })
            .then(function (response) {
                console.log("Artist Name:" + response.tracks.items[0].artists[0].name);
                console.log("Track Name:" + response.tracks.items[0].name);
                console.log("Preview URL:" + response.tracks.items[0].preview_url);
    ...
    if (process.argv[3] != null) {
        ...
        request(queryUrl, function (error, response, body) {
            if (!error && response.statusCode === 200) {
                ...
                console.log("Title of the movie: " + details.Title);
                console.log("Year the movie came out: " + details.Year);
                console.log("IMDB Rating of the movie: " + details.imdbRating);
                console.log("Rotten Tomatoes Rating of the movie: " + details.Ratings[1].Value);
                console.log("Country where the movie was produced: " + details.Country);
                console.log("Language of the movie: " + details.Language);
                console.log("Plot of the movie: " + details.Plot);
                console.log("Actors in the movie: " + details.Actors);
            }
        });
    } else {
...
function mytweets() {
    ...
    var params = { screen_name: 'Appy88402660', count: 20 };
